...
MODEL_PATH = '/media/yons/data/dataset/pointCloud/RandLA_net/models/Semantic3D/snap-37001'
...
class Semantic3D:
    def __init__(self):
        ...
        self.original_folder = join(self.path, 'sse-images')
    ...
    def init_input_pipeline(self):
        ...
        if MODE == 'test':
            ...
            iter = tf.data.Iterator.from_structure(self.batch_test_data.output_types,
            ...
            iter = tf.data.Iterator.from_structure(self.batch_train_data.output_types,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', type=int, default=GPU, help='the number of GPUs to use [default: 0]')
    parser.add_argument('--mode', type=str, default=MODE, help='options: train, test, vis')
    parser.add_argument('--mode_path', type=str, default=MODEL_PATH, help='pretrained model path')
